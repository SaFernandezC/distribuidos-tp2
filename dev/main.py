...
def main():
    ...
    while True:
        ...
        for _i in range(amount):
            ...
            # container = client.containers.get(containers[to_stop])
            # container.stop()
